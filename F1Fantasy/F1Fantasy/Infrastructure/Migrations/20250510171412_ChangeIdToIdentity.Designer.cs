...
namespace F1Fantasy.Infrastructure.Migrations
{
    ...
    [Migration("20250510171412_ChangeIdToIdentity")]
    partial class ChangeIdToIdentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("F1Fantasy.Core.Common.Circuit", b =>
                {
                    ...
                    b.Property<decimal>("Longttitude")
                        .HasColumnType("decimal(3,4)");

                    b.HasKey("Id");

                    b.HasAlternateKey("CircuitName");
